...
class usersDao {
  async getAllUsers(req, res, next) {
    try {
      const get_all_users_query = `SELECT * FROM users WHERE user_role = 'user' ORDER BY user_id ASC`;
  ...
  async getAdmin(req, res, next) {
    try {
      const get_admin_query = `SELECT * FROM users WHERE user_role = 'admin' ORDER BY user_id ASC`;
